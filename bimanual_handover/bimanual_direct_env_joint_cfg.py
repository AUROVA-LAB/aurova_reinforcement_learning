...
# Rotations respect to the end effector robot link frame for object spawning
...
@configclass
class BimanualDirectJointCfg(DirectRLEnvCfg):
    # env
    ...
    num_observations = 7 + 16 + 7  # Number of observations per environment (overridden)
    ...
    # fingertips -- thumb, index, middle, ring
    fingertip_body_names = ["hand_link_15__link_tip_link", "hand_link_3_0_link_tip_link",
                            "hand_link_7_0_link_tip_link", "hand_link_11__link_tip_link"]
    ...
    rew_scale_hand_obj_joint_space: float= 1.0
    rew_scale_obj_target_joint_space: float= 1.0

    # Position threshold for changing reach reward
    rew_change_thres = 0.1
