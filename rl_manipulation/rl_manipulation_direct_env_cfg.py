...
from source.isaaclab_tasks.isaaclab_tasks.manager_based.aurova_reinforcement_learning.rl_manipulation.robots_cfg import *
...
class RLManipulationDirectCfg(DirectRLEnvCfg):
    ...
    observation_space = 6+3     #  + img_height*img_width*3       # Number of observations per environment (overridden)
