...
parser.add_argument("--video_interval", type=int, default=5000_000, help="Interval between video recordings (in steps).")
...
parser.add_argument("--log_interval", type=int, default=5000_000, help="Log data every n timesteps.")
